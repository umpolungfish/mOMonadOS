...
pub const ALEPH_LETTERS: [AlephLetter; 22] = [
    // 3 Mothers
    AlephLetter { glyph: "א", name: "Aleph",  prim: IgPrim::if_,   family: AlephFamily::Mother, value: 1 },
    AlephLetter { glyph: "מ", name: "Mem",    prim: IgPrim::monad,    family: AlephFamily::Mother, value: 40 },
    AlephLetter { glyph: "ש", name: "Shin",   prim: IgPrim::err,   family: AlephFamily::Mother, value: 300 },
    // 7 Doubles
    AlephLetter { glyph: "ב", name: "Bet",    prim: IgPrim::eat,     family: AlephFamily::Double, value: 2 },
    AlephLetter { glyph: "ג", name: "Gimel",  prim: IgPrim::judge,    family: AlephFamily::Double, value: 3 },
    AlephLetter { glyph: "ד", name: "Dalet",  prim: IgPrim::mime, family: AlephFamily::Double, value: 4 },
    AlephLetter { glyph: "כ", name: "Kaf",    prim: IgPrim::ah,  family: AlephFamily::Double, value: 20 },
    AlephLetter { glyph: "פ", name: "Pe",     prim: IgPrim::oak, family: AlephFamily::Double, value: 80 },
    AlephLetter { glyph: "ר", name: "Resh",   prim: IgPrim::oil, family: AlephFamily::Double, value: 200 },
    AlephLetter { glyph: "ת", name: "Tav",    prim: IgPrim::awe,  family: AlephFamily::Double, value: 400 },
    // 12 Simples
    AlephLetter { glyph: "ה", name: "He",     prim: IgPrim::ian,     family: AlephFamily::Simple, value: 5 },
    AlephLetter { glyph: "ו", name: "Vav",    prim: IgPrim::measure,    family: AlephFamily::Simple, value: 6 },
    AlephLetter { glyph: "ז", name: "Zayin",  prim: IgPrim::kick,       family: AlephFamily::Simple, value: 7 },
    AlephLetter { glyph: "ח", name: "Chet",   prim: IgPrim::sure,       family: AlephFamily::Simple, value: 8 },
    AlephLetter { glyph: "ט", name: "Tet",    prim: IgPrim::ear, family: AlephFamily::Simple, value: 9 },
    AlephLetter { glyph: "י", name: "Yod",    prim: IgPrim::vow,    family: AlephFamily::Simple, value: 10 },
    AlephLetter { glyph: "ל", name: "Lamed",  prim: IgPrim::ado,  family: AlephFamily::Simple, value: 30 },
    AlephLetter { glyph: "נ", name: "Nun",    prim: IgPrim::wool,    family: AlephFamily::Simple, value: 50 },
    AlephLetter { glyph: "ס", name: "Samekh", prim: IgPrim::gag,     family: AlephFamily::Simple, value: 60 },
    AlephLetter { glyph: "ע", name: "Ayin",   prim: IgPrim::ooze,  family: AlephFamily::Simple, value: 70 },
    AlephLetter { glyph: "צ", name: "Tzadi",  prim: IgPrim::tot,    family: AlephFamily::Simple, value: 90 },
    AlephLetter { glyph: "ק", name: "Qof",    prim: IgPrim::fee,       family: AlephFamily::Simple, value: 100 },
];
