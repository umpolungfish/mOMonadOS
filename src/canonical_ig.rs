...
pub static ORDINALS: [(&str, &[(&str, f32)]); 12] = [
    ...
    ("⊙", &[("woe", 1.0), ("⊙", 2.0), ("roar", 2.33), ("𐑻", 2.67), ("𐑣", 3.0)]),
...
pub static CL8NK_FORMULAE: [(&str, &[(&str, &str, &str, &str)]); 12] = [
    ...
    ("⊙", &[("⊙", "ξ → ∞ ∧ μ∘δ = id", "PHI_C", "match"), ("roar", "ξ ∈ ℂ ∧ Im(ξ) → ∞", "", "close"), ("𐑻", "H(λ) non-Herm ∧ det(H - λI) = 0 ∧ ∂_λ H = 0", "", "distant"), ("𐑣", "ξ → ∞ ∧ chaotic(x)", "", "distant"), ("woe", "¬∃ξ( diverges(ξ) )", "", "distant")]),
