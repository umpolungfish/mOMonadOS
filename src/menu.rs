...
pub static QUANTUM_MENU: &[MenuItem] = &[
    MenuItem { name: "fibqc",      cmd: "fibqc",      desc: "Fibonacci anyon QC: verify | compile | jones | knot | winding", example: "fibqc verify", submenu: None },
    MenuItem { name: "quantum_compile", cmd: "quantum_compile", desc: "Compile a circuit over H T S X to a braid word (alias for fibqc compile)", example: "quantum_compile H T 8", submenu: None },
    MenuItem { name: "jones_polynomial", cmd: "jones_polynomial", desc: "Jones polynomial at the 1/5 winding; signed Artin generators", example: "jones_polynomial 1 1 1", submenu: None },
