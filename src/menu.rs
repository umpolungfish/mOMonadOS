...
pub static GRAMMAR_MENU: &[MenuItem] = &[
    ...
    MenuItem { name: "quantum_compile", cmd: "quantum_compile", desc: "alias for `fibqc compile` — the grammar-tool name", submenu: None },
    MenuItem { name: "jones_polynomial", cmd: "jones_polynomial", desc: "alias for `fibqc jones` — signed Artin generators, integers", submenu: None },
    MenuItem { name: "bg",       cmd: "bg",       desc: "braid word to grammar tuple: bg tuple <word> [strands]", submenu: None },
    MenuItem { name: "hqe",      cmd: "hqe",      desc: "holonomic quasi-ergodic quantale, MBL holonomy", submenu: None },
    MenuItem { name: "dyson",    cmd: "dyson",    desc: "Dyson beta-ensemble, double-ramified cycle", submenu: None },
    MenuItem { name: "troq",     cmd: "troq",     desc: "triple-ramified ouroboric quantale", submenu: None },
    MenuItem { name: "afdmc",    cmd: "afdmc",    desc: "asymptotic frozen-disordered monadic cohomology", submenu: None },
    MenuItem { name: "hop",      cmd: "hop",      desc: "universe hopping, cross-framework transport", submenu: None },
    MenuItem { name: "manifold", cmd: "manifold", desc: "topological manifold operations", submenu: None },
