...
pub static GRAMMAR_MENU: &[MenuItem] = &[
    ...
    MenuItem { name: "sk_forge", cmd: "sk_forge", desc: "Crystal Harvester: BIP39-SIC integrated structural gap analysis against O_∞ carriers; scalar is HEURISTIC, never a key. Commands: forge, tuple, word, verify, carriers, bip39-sic, bip39-pipeline", example: "sk_forge bip39-sic", submenu: None },
