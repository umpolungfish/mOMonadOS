...
axiom forcing_theorem (X : SmoothProjectiveVariety) (cert : SixChannelCertificate X) (p : ℕ) (a : HodgeCohomology X p) : IsAlgebraicClass X p a
...
axiom regulator_surjectivity_iff_hodge : RegulatorSurjectivity ↔ HodgeConjecture
...
axiom seqax_inhabitant (X : SmoothProjectiveVariety) : SEQAX_Promotion X

axiom tempd2_inhabitant (X : SmoothProjectiveVariety) : TEMPD2_Promotion X
