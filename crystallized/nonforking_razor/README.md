...
to ⊞; and that the descent crystal 3442270 and the two-fork-pair 16402270 differ
...
crystal 3442270 (parity or', Frobenius self-dual), holds, μ∘δ=id. Four of the five
negations are the byte-identical word ⊢∈≻⊤≺⊥⋈⊙⊞∋◻⊣. Only Collatz's affirmation
lands on the fork (16402270), drawing the ⊢ distinction the others leave implicit.
